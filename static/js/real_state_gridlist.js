    ...
    marker: {
        values: [{
...

            {
                ...
                data: "sydney,australia",
                options: { icon: "images/marker2.png" }
            }, {
                address: "new south wales, australia",
                data: "new south wales,australia",
                options: { icon: "images/marker2.png" }
            }, {
...

            {
                ...
                data: "south Australia,australia",
                options: { icon: "images/marker2.png" }
            }
        ],
        options: {
        ...
        events: {
            mouseover: function(marker, event, context) {
                var img = "<img src='images/gridlist/house1.png'  width='200px' height='100px' class='img-responsive'>";
