    ...
    marker:{
        values: [
            {
                ...
                data: "Utah, United States",
                options: {icon: "images/marker10.png"}
            },
            {
                address: "Wyoming, United States",
                data: "Wyoming, United States",
                options: {icon: "images/marker10.png"}
            },

            {
                address: "Denver, CO, United States",
                data:"Denver, CO, United States",
                options: {icon: "images/marker10.png"}
            },
            {
                address: "Nebraska, United States",
                data:  "Nebraska, United States",
                options: {icon: "images/marker10.png"}
            },
            {
                address: "South Dakota, United States",
                data: "South Dakota, United States",
                options: {icon: "images/marker10.png"}
            },

            {
                address: "Colorado, United States",
                data: "Colorado, United States",
                options: {icon: "images/marker10.png"}
            }
        ],
        options:{
        ...
        events:{
            mouseover: function(marker, event, context){
                var img="<img src='images/gridlist/services1.png'  width='200px' height='100px' class='img-responsive'>";
